...
"""
    ...
    Rotate the board will make the drop operation much easier. That being said, instead of move all non-zero value to the end of each column, the drop operation becomes move all non-zero value to the beginning of each row.
